    ...
    <div class="w-fit flex flex-col gap-10">
        <div class="flex items-center justify-center flex-col gap-2">
            ...
            <div class="flex items-center gap-2 justify-center">
                <a alt="Github page alexandre vargas lopez" href="https://github.com/alexandre-vl" target="_blank">
                ...
                <a alt="Linkedin page alexandre vargas lopez" href="https://www.linkedin.com/in/alexandre-vargas-lopez-1b6450233/" target="_blank">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-muted-foreground hover:text-foreground transition-all w-6 h-6" xmlns="http://www.w3.org/2000/svg">
                ...
                <a alt="Twitter page alexandre vargas lopez" href="https://twitter.com/alexx_vrgs" target="_blank">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-muted-foreground hover:text-foreground transition-all w-6 h-6" xmlns="http://www.w3.org/2000/svg">
